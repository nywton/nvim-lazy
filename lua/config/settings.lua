...
-- Open files in vertical split by default in netrw (:Ex)
-- vim.g.netrw_browse_split = 4 -- vertical split
-- vim.g.netrw_altv = 1 -- prefer vertical splits
vim.g.netrw_winsize = 80 -- width of netrw window
